...
const OtherMenu = () => {
    const menuData = [
        ...
        {
            id: 8,
            img: "../assets/img/menu8.webp",
            title: "Pesto Paradise",
            price: "16.99",
        },
        {
            id: 9,
            img: "../assets/img/menu9.webp",
            title: "Hawaiian Bliss",
            price: "16.99",
        },
        {
            id: 10,
            img: "../assets/img/menu10.webp",
            title: "Truffle Treasures",
            price: "16.99",
        },
        {
            id: 11,
            img: "../assets/img/menu11.webp",
            title: "Farmhouse Harvest",
            price: "16.99",
        },
        {
            id: 12,
            img: "../assets/img/menu12.webp",
            title: "Cheese Frenzy",
            price: "16.99",
        },
        {
            id: 13,
            img: "../assets/img/menu13.webp",
            title: "Truffle treasures",
            price: "16.99",
        },
        {
            id: 14,
            img: "../assets/img/menu14.webp",
            title: "Cheese Frenzy",
            price: "16.99",
        },
    ]
